...
When installed on-premise, it still can leverage the benefits of the same frameworks and tools you use on the cloud: Kubernetes, Kafka, Mongo and all othe components the platform is made of.
