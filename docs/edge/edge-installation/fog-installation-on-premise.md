...
The Sensoworks comes pre-packaged with a simple demo service, that monitors a simulated sensor. Follow this [**getting started guide**](../fog-getting-started-guide.md).
