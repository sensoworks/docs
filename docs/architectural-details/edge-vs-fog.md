...
The better understand the differences between Edge and Fog computing, consider al the voices of Cisco and Siemens talking about Fog computing:
...
From a very high level point of view both the Sensoworks Edge and Fog gateways share more or less the same architecture:

![](/docs/assets/images/sensoworks-architecture.jpeg)
